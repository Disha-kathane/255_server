...
const metric_conversation_analyticsController = require('../../controller/v1/metric_conversation_analytics');
...
module.exports = (upload) => {
    ...
    const conversationAnalyticsOpts = {
        handler: metric_conversation_analyticsController
    };
    ...
    return (fastify, opts, done) => {
        ...
        fastify.post('/conversationAnalytics', conversationAnalyticsOpts);
