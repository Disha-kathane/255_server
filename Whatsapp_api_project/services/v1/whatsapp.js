...
const userLogin = async (instanceUrl, waUsername, waPassword) => {
    ...
    console.log({ waApiLoginUserResponse });
    return {
...
const getPhoneNumberId = async (wabaId, waAuthToken) => {
    console.log("waAuthToken --------------> ", waAuthToken)

    const instanceUrl = config.graphFacebookUrl;
    const api = 'v13.0/' + wabaId + '/phone_numbers?limit=99999';
    const httpMethod = 0;
    const requestType = 0;
    const apiHeaders = [{
        'headerName': 'Authorization',
        'headerVal': 'Bearer ' + waAuthToken
        // 'Bearer EAAaSEd3mKP8BAKWHV3O0BxUAEZAPa9myVKWC0yY0Uhg9wP9kCTPHs4XcKL9ISZBc6secnZBUn2yOwKgtc2gfwPat4ZCG2jPZArN98exjKT5JGJXznD7KbNu6Oe3VSUG7k6KcTPIfBUeefjQPgZC1zcqs1p1laN2MUGlSBp8yvtbujvmBrqgcCb'
    }];
    const objData = {}
