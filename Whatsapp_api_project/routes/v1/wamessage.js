...
const fetchmediacontroller = require('../../controller/v1/fetchmediacontroller');
const whatsappApi = require('../../controller/v1/whatsappApi');
...
module.exports = (upload) => {
    ...
    const fetchmediaopts = {
        handler: fetchmediacontroller
    }
    ...
    return (fastify, opts, done) => {
        ...
        fastify.post('/fetchmedia', fetchmediaopts);
        fastify.get('/apiKeyToken', apiKeyTokenOpt);
