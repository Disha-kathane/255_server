...
module.exports = async (req, res) => {
    try {
        ...
        // const AccessToken = await templateService.getSystemAccessToken();//template_getSystemAccessToken
        const AccessToken = await templateService.template_getSystemAccessToken();//template_getSystemAccessToken

        const access_token = AccessToken[0].value;

        let tempListResponse = await templateService.getTemplateDetailsEdit(tempIdList, userId);
