...
module.exports = async (req, res) => {
    try {
        ...
        if (error != undefined && error.code != undefined && error.code == 'ECONNRESET') {
            ...
            tempError = error.response.data.error.error_user_msg !== undefined && error.response.data.error.error_user_msg !== "" ? error.response.data.error.error_user_msg : error.response.data.error.message;
            console.log('error block 2', tempError);
        }
