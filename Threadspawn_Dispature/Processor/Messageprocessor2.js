...
const queuename = require('../constant').queuename2;
...
const createRedisConnection = () => {
    ...
    redisConnection.on('error', (error) => {
        ...
        // }, 60000); // 10 seconds delay, you can adjust this value
    });
...
threadsqueue
    ...
    .on('failed', async function (job, err) {
        ...
        let tempJob = job;
        await threadsqueue.clean(FAILED_QUEUE_PERIOD, 'failed').then(() => console.log('Messageprocessor2 : Failed Jobs older then 24 hours from Thread payload has been removed...'));
