...
threadsqueue
    ...
    .on('failed', async function (job, err) {
        ...
        let tempJob = job;
        await threadsqueue.clean(FAILED_QUEUE_PERIOD, 'failed').then(() => console.log('Messageprocessor1 : Failed Jobs older then 24 hours from Thread payload has been removed...'));
